...
public class DrawGame extends JLabel{
    ...
    protected void paintComponent(Graphics g){
        ...
        for (int i = 0; i < Game.currentBlock.getBounds()[Game.currentBlock.getRotation()].length
                ; i++) {
            for (int j = 0; j < Game.currentBlock.getBounds()[Game.currentBlock.getRotation()].length
                ; j++){
